...
--23-- Sélectionner tous les users SAUF celui dont l'id est 5 (soyons supersticieux !) :!\ il y a 2 façons de faire
...
SELECT COUNT(*) FROM `user` WHERE `color_eyes` >= 'marron';
